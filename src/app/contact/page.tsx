      ...
      <Section>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            ...
            {isSubmitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 border border-deep-gray/20 rounded-md focus:ring-2 focus:ring-sepia focus:border-transparent"
                ...
                <div>
                  <label htmlFor="subject" className="block text-sm font-medium text-deep-gray mb-2">
                    Subject *
                  </label>
                  <select
                    id="subject"
                  ...
                  >
                    ...
                    <option value="personal-story">Share Personal Story</option>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-3 border border-deep-gray/20 rounded-md focus:ring-2 focus:ring-sepia focus:border-transparent resize-vertical"
          ...
          <div>
            ...
            <div className="space-y-6">
              <Card>
                <div className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-sepia rounded-lg flex items-center justify-center flex-shrink-0">
                    <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <div>
                    <h3 className="text-lg font-serif font-bold text-black mb-1">Email</h3>
                    <p className="text-deep-gray">
                      <a 
                        href="mailto:arthur@arthurmyronhorwitz.com"
                        className="hover:text-sepia transition-colors duration-200"
                      >
              ...
              <Card>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-serif font-bold text-black mb-1">Phone</h3>
                    <p className="text-deep-gray">
                      <a 
              ...
              <Card>
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-serif font-bold text-black mb-1">Response Time</h3>
                    <p className="text-deep-gray">
            ...
            <div className="mt-8 p-6 bg-deep-gray/5 rounded-lg">
